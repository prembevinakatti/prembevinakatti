...
def generate_typing_header(output_path="assets/typing_header.svg"):
  ...
  <defs>
    ...
    <!-- SMIL animated clip-path for typewriter reveal covering full vertical text height -->
    <clipPath id="titleTypingClip">
      <rect x="0" y="-38" width="0" height="52">
  ...
  <!-- Title Center Group (centered horizontally in 880px width) -->
  <g transform="translate(230, 40)">
    ...
    <g>
      <animateTransform attributeName="transform"
                        type="translate"
                        values="0 0; 0 0; 418 0; 418 0; 0 0"
                        keyTimes="0; 0.05; 0.35; 0.92; 1"
                        dur="9s"
                        repeatCount="indefinite" />
      <text x="6" y="-2" class="cursor-title" fill="#22D3EE">
        |
  ...
  <!-- Continuously Changing Dynamic Subtitle Lines (Centered at x=440) -->
